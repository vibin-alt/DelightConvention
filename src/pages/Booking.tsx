...
const Booking = () => {
  ...
  if (isSubmitted) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center px-4 sm:px-6">
        <Card className="w-full max-w-md sm:max-w-lg text-center">
          <CardContent className="p-6 sm:p-8">
            ...
            <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-gray-800">Booking Submitted!</h2>
            ...
            <Button 
              ...
              className="w-full sm:w-auto bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 px-4 py-2 text-sm sm:text-base"
            >
              Book Another Event
            </Button>
          </CardContent>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="bg-gradient-to-r from-purple-600 to-blue-600 text-white py-12 sm:py-16 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6">Book Your Event</h1>
        ...
        <div className="max-w-4xl mx-auto">
          <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
            ...
            <Card className="h-fit">
              <CardHeader>
                <CardTitle className="text-xl sm:text-2xl text-gray-800">Contact Information</CardTitle>
              </CardHeader>
            ...
            <Card className="h-fit">
              <CardHeader>
                <CardTitle className="text-xl sm:text-2xl text-gray-800">Select Your Dates</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4 sm:space-y-6">
                <div>
                  <Label className="text-sm sm:text-base">Add Preferred Dates *</Label>
                  <Popover open={isCalendarOpen} onOpenChange={setIsCalendarOpen}>
                    <PopoverTrigger asChild>
                      <Button
                        variant="outline"
                        className="w-full justify-start text-left font-normal mt-1 sm:mt-2 text-sm sm:text-base"
                        type="button"
                      >
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        initialFocus
                        className="p-2 sm:p-3 pointer-events-auto w-full sm:w-auto"
                      />
                    </PopoverContent>
                  </Popover>
                </div>
                ...
                {selectedDates.length > 0 && (
                  <div className="space-y-2">
                    <Label className="text-sm sm:text-base">Selected Dates:</Label>
                    <div className="space-y-2">
                      {selectedDates.map((date, index) => (
                        <div key={index} className="flex items-center justify-between bg-gray-50 p-2 sm:p-3 rounded-lg">
                          <span className="font-medium text-sm sm:text-base">{format(date, "PPP")}</span>
                          <Button
                            type="button"
                            variant="ghost"
                            size="sm"
                ...
                {selectedDates.length > 0 && (
                  <div className="space-y-4">
                    {!hasDateConflicts ? (
                      <div className="flex items-center space-x-2 text-green-600 bg-green-50 p-2 sm:p-3 rounded-lg">
                        <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5" />
                        <span className="font-medium text-sm sm:text-base">Great! All selected dates are available.</span>
                      </div>
                    ) : (
                      <div className="space-y-4">
                        <div className="flex items-center space-x-2 text-red-600 bg-red-50 p-2 sm:p-3 rounded-lg">
                          <XCircle className="h-4 w-4 sm:h-5 sm:w-5" />
                          <span className="font-medium text-sm sm:text-base">Some selected dates are already booked.</span>
                        </div>
                        
                        {alternativeDates.length > 0 && (
                          <div className="bg-blue-50 p-3 sm:p-4 rounded-lg">
                            <h4 className="font-medium text-blue-800 mb-2 sm:mb-3 text-sm sm:text-base">Here are alternative available dates:</h4>
                            <div className="space-y-2 flex flex-wrap gap-2">
                              {alternativeDates.map((date, index) => (
                                <Button
                                  ...
                                  className="mr-2 mb-2 border-blue-200 hover:bg-blue-100 text-xs sm:text-sm"
                                >
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-sm sm:text-lg py-4 sm:py-6"
